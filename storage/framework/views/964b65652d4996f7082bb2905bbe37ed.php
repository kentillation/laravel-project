...
<?php $__env->startSection('page-content'); ?>
        <div class="mt-5 mb-5">
            <div class="container border rounded p-5 reports">
                <h1 class="heading1 text-center mb-5"><strong>CANCELLED REQUESTS</strong></h1>
                <div class="search">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#">
                                            <button class="btn-restricted" title="ADD TO RESTRICTED REQUESTERS">
                                                <i class="bi bi-plus-lg p-1"></i>
                                            </button>
                                        </a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('includes/sidenav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\NOLITC17\Documents\Kent\Activities\Laravel\first-project\resources\views/pages/Reports/cancelled.blade.php ENDPATH**/ ?>